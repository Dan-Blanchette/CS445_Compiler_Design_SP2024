...
{
       0,   113,   113,   118,   119,   120,   124,   125,   129,   130,
     134,   141,   142,   146,   147,   151,   152,   156,   157,   161,
     162,   163,   168,   169,   174,   175,   179,   180,   187,   197,
     198,   203,   205,   210,   211,   216,   217,   218,   220,   221,
     222,   223,   227,   228,   234,   235,   236,   237,   243,   244,
     248,   249,   255,   256,   262,   263,   267,   268,   272,   276,
     277,   278,   279,   280,   284,   285,   286,   287,   288,   292,
     293,   297,   298,   302,   303,   307,   308,   312,   313,   314,
     315,   316,   317,   321,   322,   326,   327,   331,   332,   336,
     337,   341,   342,   346,   347,   348,   352,   353,   357,   358,
     359,   363,   364,   369,   371,   376,   377,   378,   386,   390,
     391,   399,   400,   404,   409,   414,   418
};
#endif
...
#line 142 "parser.y" /* yacc.c:1646  */
    {(yyval.tree) = (yyvsp[-1].tree); setType((yyvsp[-1].tree), (yyvsp[-2].type), false); (yyval.tree)->isStatic=false;}
...
#line 156 "parser.y" /* yacc.c:1646  */
    {(yyval.tree) = newDeclNode(DeclKind::VarK, UndefinedType, (yyvsp[0].Token_Data)); (yyval.tree)->isArray = false; }
#line 1559 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 18:
#line 157 "parser.y" /* yacc.c:1646  */
    {(yyval.tree) = newDeclNode(DeclKind::VarK, UndefinedType, (yyvsp[-3].Token_Data)); (yyval.tree)->isArray = true;}
